...
def generate_invalid_parameters():
    """
    Генерирует список невалидных параметров.

    Returns:
        List[str]: Список (параметр)
    """
    test_cases = []

    # Параметры, которые должны вернуть 400
...
def test_movies_get_negative(invalid_parameter: str):
    ...
    try:
        ...
        # Для ошибочных запросов (400) проверяем структуру ошибки
